...
const struct grammar * const get_poppy_grammar(){
        ...
        populate(SYMBOL_TYPE, {SYMBOL_MUT COMMA SYMBOL_TYPE}, i, poppy_grammar); ++i;
        ...
        populate(SYMBOL_EXPR, {SYMBOL_OREXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_OREXPR, {SYMBOL_OREXPR COMMA SYMBOL_OR COMMA SYMBOL_ANDEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_OREXPR, {SYMBOL_ANDEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_ANDEXPR, {SYMBOL_ANDEXPR COMMA SYMBOL_AND COMMA SYMBOL_EQEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_ANDEXPR, {SYMBOL_EQEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_EQEXPR, {SYMBOL_EQEXPR COMMA SYMBOL_EQ COMMA SYMBOL_COMPEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_EQEXPR, {SYMBOL_EQEXPR COMMA SYMBOL_NE COMMA SYMBOL_COMPEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_EQEXPR, {SYMBOL_COMPEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_COMPEXPR, {SYMBOL_COMPEXPR COMMA SYMBOL_LT COMMA SYMBOL_BOREXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_COMPEXPR, {SYMBOL_COMPEXPR COMMA SYMBOL_GT COMMA SYMBOL_BOREXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_COMPEXPR, {SYMBOL_COMPEXPR COMMA SYMBOL_LE COMMA SYMBOL_BOREXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_COMPEXPR, {SYMBOL_COMPEXPR COMMA SYMBOL_GE COMMA SYMBOL_BOREXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_COMPEXPR, {SYMBOL_BOREXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_BOREXPR, {SYMBOL_BOREXPR COMMA SYMBOL_BOR COMMA SYMBOL_BXOREXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_BOREXPR, {SYMBOL_BXOREXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_BXOREXPR, {SYMBOL_BXOREXPR COMMA SYMBOL_BXOR COMMA SYMBOL_BANDEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_BXOREXPR, {SYMBOL_BANDEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_BANDEXPR, {SYMBOL_BANDEXPR COMMA SYMBOL_AMP COMMA SYMBOL_BSHIFTEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_BANDEXPR, {SYMBOL_BSHIFTEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_BSHIFTEXPR, {SYMBOL_BSHIFTEXPR COMMA SYMBOL_BLEFT COMMA SYMBOL_ADDEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_BSHIFTEXPR, {SYMBOL_BSHIFTEXPR COMMA SYMBOL_BRIGHT COMMA SYMBOL_ADDEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_BSHIFTEXPR, {SYMBOL_ADDEXPR}, i, poppy_grammar); ++i;
        ...
        populate(SYMBOL_MULTEXPR, {SYMBOL_MULTEXPR COMMA SYMBOL_STAR COMMA SYMBOL_UNARYEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_MULTEXPR, {SYMBOL_MULTEXPR COMMA SYMBOL_DIVIDE COMMA SYMBOL_UNARYEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_MULTEXPR, {SYMBOL_MULTEXPR COMMA SYMBOL_MOD COMMA SYMBOL_UNARYEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_MULTEXPR, {SYMBOL_UNARYEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_UNARYEXPR, {SYMBOL_INC COMMA SYMBOL_UNARYEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_UNARYEXPR, {SYMBOL_DEC COMMA SYMBOL_UNARYEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_UNARYEXPR, {SYMBOL_MINUS COMMA SYMBOL_UNARYEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_UNARYEXPR, {SYMBOL_NOT COMMA SYMBOL_UNARYEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_UNARYEXPR, {SYMBOL_BNOT COMMA SYMBOL_UNARYEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_UNARYEXPR, {SYMBOL_STAR COMMA SYMBOL_UNARYEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_UNARYEXPR, {SYMBOL_AMP COMMA SYMBOL_UNARYEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_UNARYEXPR, {SYMBOL_MEMBEREXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_MEMBEREXPR, {SYMBOL_MEMBEREXPR COMMA SYMBOL_LBRACKET COMMA SYMBOL_EXPR COMMA SYMBOL_RBRACKET}, i, poppy_grammar); ++i;
        populate(SYMBOL_MEMBEREXPR, {SYMBOL_MEMBEREXPR COMMA SYMBOL_DOT COMMA SYMBOL_IDENTIFIER}, i, poppy_grammar); ++i;
        populate(SYMBOL_MEMBEREXPR, {SYMBOL_MEMBEREXPR COMMA SYMBOL_DOTDOT COMMA SYMBOL_IDENTIFIER}, i, poppy_grammar); ++i;
        populate(SYMBOL_MEMBEREXPR, {SYMBOL_BASEEXPR}, i, poppy_grammar); ++i;
        populate(SYMBOL_BASEEXPR, {SYMBOL_LPAREN COMMA SYMBOL_EXPR COMMA SYMBOL_RPAREN}, i, poppy_grammar); ++i;
        populate(SYMBOL_BASEEXPR, {SYMBOL_TRUE}, i, poppy_grammar); ++i;
        populate(SYMBOL_BASEEXPR, {SYMBOL_FALSE}, i, poppy_grammar); ++i;
        populate(SYMBOL_BASEEXPR, {SYMBOL_CALL}, i, poppy_grammar); ++i;
        populate(SYMBOL_BASEEXPR, {SYMBOL_CAST}, i, poppy_grammar); ++i;
        populate(SYMBOL_BASEEXPR, {SYMBOL_IDENTIFIER}, i, poppy_grammar); ++i;
        populate(SYMBOL_BASEEXPR, {SYMBOL_CONSTANT}, i, poppy_grammar); ++i;
        populate(SYMBOL_BASEEXPR, {SYMBOL_CHARLIT}, i, poppy_grammar); ++i;
        populate(SYMBOL_BASEEXPR, {SYMBOL_STRINGLIT}, i, poppy_grammar); ++i;
        populate(SYMBOL_BASEEXPR, {SYMBOL_ASM COMMA SYMBOL_LPAREN COMMA SYMBOL_STRINGLIT COMMA SYMBOL_RPAREN}, i, poppy_grammar); ++i;
