...
_keyword_:
- One of __asm__, __bool__, __char__, __declare__, __else__, __false__, __for__, __hop__, __if__, __int__, __let__, __record__, __safe__, __true__, __unsafe__, __void__, __while__
